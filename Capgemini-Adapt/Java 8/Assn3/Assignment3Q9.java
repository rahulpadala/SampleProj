...
public static void main(String[] args) {  
    ...
    Account b2=new Account(3,100000,"Bunny","Yes");  
    Account b3=new Account(5,300000,"Vinay","Yes");  
    Account b4=new Account(2,50000,"Prakash","No");
    Account b5=new Account(4,90000,"Sam","No");
    ...
    //Traversing TreeSet  
    for(Account b:set){  
    System.out.println("Account Id: "+b.getAcc_ID()+"| Bank balance: "+b.getAcc_balance()+"| Name of Acoount Holder: "+b.getAccountHolderName()+"| Salary acount?: "+b.getIsSalaryAccount());  
    }  
}  
} 